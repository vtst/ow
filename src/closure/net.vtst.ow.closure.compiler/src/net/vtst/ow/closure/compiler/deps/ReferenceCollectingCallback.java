...
public class ReferenceCollectingCallback
    ...
    /**
     * Maps a given variable to a collection of references to that name. Note that Var objects are
     * not stable across multiple traversals (unlike scope root or name).
     */
    ...
    public Scope getScope(Var var) {
        ...
        try {
            Field scope = var.getClass().getField("scope");
            return (Scope) scope.get(var);
        } catch (Exception e) {
    ...
    public void exitScope(NodeTraversal t) {
        ...
        if (t.getScope().isGlobal()) {
            //TODO:what's the harm in leaving this out? Seriously, what is it?
//            try {
//                Method getGlobalVarReferences =
//                        compiler.getClass().getDeclaredMethod("getGlobalVarReferences");
//                Method updateGlobalVarReferences =
//                        compiler.getClass().getDeclaredMethod("updateGlobalVarReferences", Map.class,
//                                Node.class);
//                // Update global scope reference lists when we are done with it.
//                updateGlobalVarReferences.invoke(compiler, referenceMap, t.getScopeRoot());
//            } catch (Exception e) {
//                throw new RuntimeException(e);
//            }
            ...
            // GlobalVarReferenceMap map = getGlobalVarReferences.invoke(compiler);
            behavior.afterExitScope(t, map);
        } else {
    ...
    static class ReferenceCollection implements Iterable<Reference> {
         ...
         * 
         *        This is either the declaration if a value is assigned (such as "var a = 2",
         *        "function a()...", "... catch (a)...").
         */
         ...
         *        reference. That is, an assignment immediately follow a variable declaration that
         *        itself does not initialize the variable.
         */
        ...
        /**
         * @return The reference that provides the value for the variable at the time of the first
         *         read, if known, otherwise null.
         * 
         *         This is either the variable declaration ("var a = ...") or first reference
         *         following the declaration if it is an assignment.
         */
    ...
    static final class Reference implements StaticReference<JSType> {
        ...
        private static final Set<Integer> DECLARATION_PARENTS = ImmutableSet.of(Token.VAR,
                                                                      Token.FUNCTION, Token.CATCH);
        ...
        static Reference newBleedingFunction(NodeTraversal t, BasicBlock basicBlock, Node func) {
            ...
            return new Reference(func.getFirstChild(), basicBlock, t.getScope(), t.getInput()
                    .getInputId());
        }
        ...
        /**
         * @return For an assignment, variable declaration, or function declaration return the
         *         assigned value, otherwise null.
         */
        ...
        boolean isLvalue() {
            ...
            return (parentType == Token.VAR && nameNode.getFirstChild() != null)
                    || parentType == Token.INC || parentType == Token.DEC
    ...
    static final class BasicBlock {
        ...
        /**
         * Determines whether the block may not be part of the normal control flow, but instead
         ...
         * script in a hot-swap fashion a new instance of {@code BasicBlock} is created.
         * 
        ...
        boolean provablyExecutesBefore(BasicBlock thatBlock) {
            ...
            for (currentBlock = thatBlock; currentBlock != null && currentBlock != this; currentBlock =
