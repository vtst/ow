...
public class LessHighlightingConfiguration extends EasyHighlightingConfiguration {
  ...
  public EasyTextAttribute SELECTOR_ROOT = new EasyTextAttribute(0, 0, 192, SWT.BOLD);
  public EasyTextAttribute SELECTOR_HASH = new EasyTextAttribute(0, 0, 192, SWT.BOLD);
  public EasyTextAttribute SELECTOR_CLASS = new EasyTextAttribute(0, 0, 192, SWT.BOLD);
